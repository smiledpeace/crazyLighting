...
/* harmony import */ var vue_class_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(0);
...
"use strict";
/* harmony import */ var vue_property_decorator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/**
...
Component.options.__file = "G:\\project\\crazyLighting\\public\\mobile\\pages\\index.vue"
...
// EXTERNAL MODULE: ./public/mobile/pages/index.vue
var pages = __webpack_require__(5);
var pages_default = /*#__PURE__*/__webpack_require__.n(pages);

// CONCATENATED MODULE: ./public/js/common/fn.ts
/*
//                    _ooOoo_
//                   o8888888o
//                   88" . "88
...
var MAX_ARRAY_INDEX = Math.pow(2, 53) - 1, //js数组最大索引号
fn_toString = window.toString;
...
var api = {
    //类型判断
    //数组
    findName: function (info, name, search_key) {
        if (search_key === void 0) { search_key = 'name'; }
        if (Array.isArray(info)) {
            return info.find(function (item) { return item[search_key] === name; }) || { value: { value_name: '' } };
        }
        var findkey = Object.keys(info).find(function (key) { return info[key][search_key] === name; });
        return findkey ? info[findkey] : { value: { value_name: '' } };
    },
    isarray: Array.isArray || function (target) {
        return fn_toString.call(target) === '[object Array]';
    },
    //类数组
    ...
    isboolean: function (target) {
        return target === true || target === false || fn_toString.call(target) === '[object Boolean]';
    },
    isdate: function (target) {
        return fn_toString.call(target) === '[object Date]';
    },
    ...
    isPlainObject: function (obj) {
        ...
        if (!obj || fn_toString.call(obj) !== "[object Object]") {
            return false;
        }
        proto = getProto(obj);
    ...
    //获取对象自有属性值（数组）
    values: function (obj) {
        var keys = api.keys(obj), len = keys.length, i = 0, arr = Array(len);
        for (; i < len; i++) {
            arr[i] = obj[keys[i]];
        }
        return arr;
    },
    sendNotice: function (type, timeout) {
        if (!type) {
            return false;
        }
        try {
    ...
    extend: function (obj, deep, copy) {
        var len = arguments.length, idx = 1, isdeep = false;
        if (len < 2 || obj === null) {
            return obj;
        }
        ...
        var source, keys, proplen, i, key, iscopyarr, clone;
        for (; idx < len; idx++) { //多对象
    ...
    each: function (dataset, fn, context) {
    ...
    later: function (fn, delay, immediate) {
        var timer;
        return function () {
            var context = this, args = arguments, callnow = immediate && !timer;
            clearTimeout(timer);
    ...
    // fmt = '-M5'; //五个月前
    // fmt = '+M5'; //五个月后
    adddate: function (date, fmt) {
        var dateplus, matchs, mothed, type, value;
    ...
    //筛选用户
    queryusers: function (keywords, source) {
        var res = [];
...
/* harmony default export */ var fn = (api);

// CONCATENATED MODULE: ./public/js/common/vueUtil.ts
...
var learn = __webpack_require__(3);
